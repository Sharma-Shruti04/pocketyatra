...
export default function Layout({ children, user }) {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 text-gray-800 dark:text-gray-100 flex flex-col transition-colors duration-300">
      <Navbar user={user} />
      <main className="flex-1 max-w-7xl mx-auto px-4 pt-4 pb-0 flex flex-col w-full">{children}</main>
      <Footer />
    </div>
  );
}
