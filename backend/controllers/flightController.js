...
export const searchFlights = async (req, res) => {
  try {
    ...
    if (!process.env.GEMINI_API_KEY) {
      // Dummy flights
      const dummyFlights = [
        { airline: "IndiGo", departure_time: "08:30 AM", arrival_time: "10:45 AM", duration: "2h 15m", price_in_inr: 4899 },
        { airline: "Air India", departure_time: "11:45 AM", arrival_time: "02:10 PM", duration: "2h 25m", price_in_inr: 5250 },
        { airline: "SpiceJet", departure_time: "06:00 PM", arrival_time: "08:15 PM", duration: "2h 15m", price_in_inr: 4999 },
      ];
